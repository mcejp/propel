   ...
   (#%begin
    ...
    (#%begin
     ...
     (#%while
      (#%app < column 4)
      (#%begin
       (#%set-var output-pos (#%app update-column column y dir output-pos))
       (#%set-var column (#%app + column 1)))))
    (#%begin
     (#%define columnn 0)
     (#%while
      (#%app < columnn 4)
 ...
 ((#<path:tests/2048.rkt> 0 0 0 4351)
  ...
  ((#f 1 -48 5 60)
   ...
   ((#f 0 -19 -19 60)
    ...
    ((#f 0 12 12 23)
     ...
     ((#f 0 5 5 11) (#f 0 1 1 5) (#f 0 6 6 3)))
    (#f 0 6 6 4)))
  ((#f 2 -55 7 16) (#f 0 0 0 16) (#f 0 5 5 8) (#f 0 9 9 1))
  ((#f 2 -14 4 95)
   (#f 0 0 0 95)
   (#f 0 7 7 7)
   ((#f 0 8 8 29)
  ...
  ((#f 5 -4 78 308)
   ...
   ((#f 0 -38 -38 308)
    ...
    ((#f 2 -16 6 82)
     (#f 0 0 0 82)
     ((#f 0 0 0 82) (#f 0 0 0 82) (#f 0 11 11 6) (#f 0 -11 -11 82))
     ((#f 0 0 0 82)
      (#f 0 0 0 82)
      ((#f 0 0 0 82) (#f 0 0 0 82) (#f 0 0 0 82) (#f 0 11 11 6) (#f 0 7 7 1))
      ((#f 0 -18 -18 82)
       (#f 0 0 0 82)
       ((#f 1 2 24 57)
        (#f 0 0 0 57)
    ...
    ((#f 3 0 86 96)
     (#f 0 0 0 96)
     ((#f 0 0 0 96) (#f 0 0 0 96) (#f 0 11 11 7) (#f 0 -11 -11 96))
     ((#f 0 0 0 96)
      (#f 0 0 0 96)
      ((#f 0 0 0 96) (#f 0 0 0 96) (#f 0 0 0 96) (#f 0 11 11 7) (#f 0 8 8 1))
      ((#f 0 -19 -19 96)
       (#f 0 0 0 96)
       ((#<path:propel-builtins.rkt> -23 5 -872 72)
        ...
        ((#f 1 2 16 55)
         ...
         ((#<path:propel-builtins.rkt> -21 -60 -900 6)
          (#f 0 0 0 6)
          (#f 0 1 1 4))))
       ((#<path:tests/2048.rkt> 20 -10 807 96)
        (#f 0 0 0 96)
        (#f 0 11 11 7)
        ((#f 0 -11 -11 96)
         (#f 0 0 0 96)
