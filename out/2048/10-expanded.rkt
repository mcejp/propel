((begin
   (def get-player-input (#%external-function get-player-input () int #f))
   (def
    random-int
 ...
 ((#<path:tests/2048.rkt> 0 0 0 4069)
  ...
  ((#f 3 -17 65 1025)
   ...
   ((#f 2 -16 6 774)
    ...
    ((#f 0 0 0 774)
     (#f 0 0 0 774)
     ((#f 0 0 0 774) (#f 0 0 0 774) (#f 0 9 9 1) (#f 0 2 2 1))
     ((#f 0 -11 -11 774)
      (#f 0 0 0 774)
      ((#f 2 2 62 43)
       (#f 0 1 1 3)
      ...
      ((#<path:propel-builtins.rkt> 16 -35 405 72)
       ...
       ((#f 1 1 15 55)
        (#f 0 1 1 2)
        (#<path:tests/2048.rkt> -16 0 -406 5)
        ((#<path:propel-builtins.rkt> 17 1 425 16)
         (#f 0 1 1 5)
         ((#<path:tests/2048.rkt> -15 -6 -298 176)
          (#f 0 1 1 3)
          (#f 0 4 4 12)
          ((#f 0 13 13 157)
           (#f 0 1 1 4)
        ...
        ((#<path:propel-builtins.rkt> 4 -30 -173 6) (#f 0 1 1 4))))
      ((#<path:tests/2048.rkt> -21 -10 -570 774)
       (#f 0 0 0 774)
       (#f 0 9 9 1)
       ((#f 0 -9 -9 774) (#f 0 0 0 774) (#f 0 9 9 1) (#f 0 -9 -9 774))))))
   ((#f 22 0 778 100)
    (#f 0 0 0 100)
    ((#f 0 0 0 100) (#f 0 0 0 100) (#f 0 9 9 7) (#f 0 -9 -9 100))
    ((#f 0 0 0 100)
     (#f 0 0 0 100)
     ((#f 0 0 0 100) (#f 0 0 0 100) (#f 0 9 9 7) (#f 0 8 8 1))
     ((#f 0 -17 -17 100)
      (#f 0 0 0 100)
      ((#<path:propel-builtins.rkt> -4 5 -273 72)
       ...
       ((#f 1 1 15 55)
        (#f 0 1 1 2)
        ((#<path:tests/2048.rkt> 4 0 285 23)
         (#f 0 1 1 2)
         (#f 0 3 3 10)
         (#f 0 11 11 7))
        ((#<path:propel-builtins.rkt> -3 -14 -281 16)
         (#f 0 1 1 5)
         ((#<path:tests/2048.rkt> 4 -6 295 39)
          (#f 0 1 1 21)
          (#f 0 22 22 7)
          (#f 0 8 8 1)
          (#f 0 2 2 3)
          (#f 0 4 4 1)))
        ((#<path:propel-builtins.rkt> -3 -32 -305 6) (#f 0 1 1 4))))
      ((#<path:tests/2048.rkt> 1 -10 208 100)
       (#f 0 0 0 100)
       (#f 0 9 9 7)
       ((#f 0 -9 -9 100) (#f 0 0 0 100) (#f 0 9 9 7) (#f 0 -9 -9 100)))))))
  ((#f 5 -2 104 736)
   (#f 0 1 1 5)
   (#f 0 6 6 18)
   ((#f 0 19 19 2))
  ...
  ((#f 6 -15 124 1270)
   ...
   ((#f 29 -27 1115 40)
    ...
    ((#f 0 0 0 40)
     (#f 0 0 0 40)
     ((#f 0 0 0 40) (#f 0 0 0 40) (#f 0 9 9 3) (#f 0 4 4 1))
     ((#f 0 -13 -13 40)
      (#f 0 0 0 40)
      ((#f 1 2 19 20) (#f 0 1 1 10) (#f 0 11 11 3) (#f 0 4 4 3))
      ((#f -1 -18 -35 40)
       (#f 0 0 0 40)
       (#f 0 9 9 3)
       ((#f 0 -9 -9 40) (#f 0 0 0 40) (#f 0 9 9 3) (#f 0 -9 -9 40)))))))))
